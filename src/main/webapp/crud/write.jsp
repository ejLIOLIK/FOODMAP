                ...
                <main>
                    <div class="container-fluid px-4">	
                        ...
                        <ol class="breadcrumb mb-4">
                            ...
                            <%if(!"null".equals(request.getParameter("category"))){ %>
                            <option value="<%=request.getParameter("category")%>" selected="selected"><%=request.getParameter("category") %></option><%} %>
                        ...
                        <div class="card mb-4">
                            <div class="card-body">
                                ...
                                상호명: <input type="text" name="title"> <br> <hr>
								내용: <textarea name="text"></textarea> <br> <hr>
